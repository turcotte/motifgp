...
This version of the software is released to further development and collect feedback before a broader release to the
software, bioinformatics and computational biology communities. We plan on releasing it on a public source code repository
...
Options:
  ...
  -m MOO, --moo=MOO     Multi-objective optimization [SPEA2, NSGA2, FORTIN].
                        FORTIN is the NSGA2R algorithm improvement of NSGA2.
  -f FITNESS, --fitness=FITNESS
                        Objective fitness function. Use a string of length 1-3
                        with chars [D,F,I,S,O] (for [Discrimination, Fisher's
                        Exact Test, Fisher's Exact Test (Scipy), Support, Odds
                        Ratio (Scipy)] to order objective functions. Default
                        is 'DF' for [Discrimination,Fisher] (2-objectives).
